...
function TrackingItem({data}:any) : any{
    return (
        <div className={combineClasses(styles.trackingitem,"trackingitem w-1/4 flex flex-col gap-2 bg-white relative")}>
            <div className="top w-full text-base"><p>{data.heading}</p></div>
