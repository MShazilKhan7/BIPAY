...
class Employee(models.Model):
    ...
    department_emp  = models.ForeignKey(Department, on_delete=models.PROTECT, related_name="employees", blank=True)
    designation_emp = models.ForeignKey(Designation, on_delete=models.DO_NOTHING, blank=True)
    status          = models.CharField(max_length=10, choices=statusChoices, blank=True)
